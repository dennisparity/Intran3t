  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <h2 className="text-2xl font-bold text-[#1c1917] dark:text-[#fafaf9] mb-2 font-serif">
      ...
      <div className="space-y-3">
        <div className="flex items-start gap-3 p-3 rounded-lg bg-[#fafaf9] dark:bg-[#292524] border border-[#e7e5e4] dark:border-[#44403c]">
          <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
          <div>
            <h3 className="font-semibold text-[#1c1917] dark:text-[#fafaf9] text-sm">Governance Access</h3>
        ...
        <div className="flex items-start gap-3 p-3 rounded-lg bg-[#fafaf9] dark:bg-[#292524] border border-[#e7e5e4] dark:border-[#44403c]">
          ...
          <div>
            <h3 className="font-semibold text-[#1c1917] dark:text-[#fafaf9] text-sm">Forms & Surveys</h3>
            <p className="text-xs text-[#78716c] dark:text-[#a8a29e] mt-0.5">
        ...
        <div className="flex items-start gap-3 p-3 rounded-lg bg-[#fafaf9] dark:bg-[#292524] border border-[#e7e5e4] dark:border-[#44403c]">
          ...
          <div>
            <h3 className="font-semibold text-[#1c1917] dark:text-[#fafaf9] text-sm">NFT Access Passes</h3>
            <p className="text-xs text-[#78716c] dark:text-[#a8a29e] mt-0.5">
        ...
        <div className="flex items-start gap-3 p-3 rounded-lg bg-[#fafaf9] dark:bg-[#292524] border border-[#e7e5e4] dark:border-[#44403c]">
          ...
          <div>
            <h3 className="font-semibold text-[#1c1917] dark:text-[#fafaf9] text-sm">Quick Navigation & Help</h3>
            <p className="text-xs text-[#78716c] dark:text-[#a8a29e] mt-0.5">
      ...
      {/* Note */}
      <p className="text-xs text-center text-[#a8a29e] dark:text-[#78716c]">
