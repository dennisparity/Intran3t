        ...
        <div className="p-6 space-y-6">
          {isLoading ? (
            <div className="flex items-center justify-center py-12">
              <div className="animate-spin rounded-full h-8 w-8 border-2 border-[#1c1917] border-t-transparent" />
            </div>
          ) : (
            <>
              {/* Profile Header */}
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {/* Role Badge */}
                  {teamMember?.role && (
                    <div className="inline-flex items-center gap-1 px-3 py-1 bg-[#f5f5f4] border border-[#e7e5e4] text-[#1c1917] text-xs font-medium rounded-full mb-2">
                      ...
                      <div className="flex items-center gap-3 p-3 bg-[#fafaf9] rounded-lg border border-[#e7e5e4]">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <a
                            ...
                            className="text-sm text-[#1c1917] font-medium hover:underline truncate block"
                          >
                            {identity.web}
                          </a>
                        </div>
