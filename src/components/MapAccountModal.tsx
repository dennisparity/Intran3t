    ...
    <Dialog open onOpenChange={onClose}>
      <DialogContent className="max-w-md">
          ...
          <>
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2">
                <AlertCircle className="w-5 h-5 text-[#1c1917]" />
                Map Your Account
              </DialogTitle>
              <DialogDescription>
                Connect your Substrate account to interact with smart contracts
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-[#fafaf9] border border-[#e7e5e4] rounded-lg p-3">
        ...
        {step === 'signing' && (
          <>
            <DialogHeader>
              ...
              <DialogDescription>Please confirm in your wallet</DialogDescription>
            </DialogHeader>
        ...
        {step === 'success' && (
          <>
            <DialogHeader>
              <DialogTitle>Account Mapped!</DialogTitle>
              <DialogDescription>Your account is now ready for smart contracts</DialogDescription>
            </DialogHeader>
            <div className="text-center py-8">
        ...
        {step === 'error' && (
          <>
            <DialogHeader>
              <DialogTitle>Mapping Failed</DialogTitle>
              <DialogDescription>There was an error mapping your account</DialogDescription>
            </DialogHeader>
